...
class HUD:
    ...
    def show_dialog(self, text, font_size, pos_x, pos_y, width, height, highlight_words=None, highlight_font_size=None,
        ...
        lines, line_heights = self.split_lines(text, font_size, width - 50, highlight_words, highlight_color,
                                               highlight_font_size)
        ...
        for i, (line, colors, sizes) in enumerate(lines):
            ...
            for segment, color, size in zip(line, colors, sizes):
                ...
                text_rect = text_surface.get_rect(
                    topleft=(pos_x - width // 2 + x_offset, pos_y - height // 2 + y_offset))
    ...
    def show_error_window(self, msg=None, msg_color=None):
        """
