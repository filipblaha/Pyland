...
<tileset version="1.10" tiledversion="1.10.2" name="Light Shadow" tilewidth="16" tileheight="16" tilecount="55" columns="11">
 <image source="../../graphics/tilesets/Grass Shadow Light.png" width="176" height="80"/>
 <wangsets>
  <wangset name="Light Shadow" type="corner" tile="-1">
   <wangcolor name="Shadow" color="#ff0000" tile="-1" probability="1"/>
